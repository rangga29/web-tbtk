...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.school-activity.update', $school_activity->slug) }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" placeholder="Judul Kegiatan Sekolah"
                                    value="{{ old('title', $school_activity->title) }}" autofocus>
                                @error('title')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" id="slug" placeholder="Slug Kegiatan Sekolah"
                                    value="{{ old('slug', $school_activity->slug) }}" readonly>
                                @error('slug')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('sub_name') is-invalid @enderror" name="sub_name" id="sub_name" placeholder="Sub Judul Kegiatan Sekolah"
                                    value="{{ old('sub_name', $school_activity->sub_name) }}">
                                @error('sub_name')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-3">
                                <input type="hidden" name="oldBackground" value="{{ $school_activity->background }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="10">{{ old('content', $school_activity->content) }}</textarea>
                                @error('content')
                                    <small class="text-danger">* {{ $message }}</small>
                                @enderror
                            </div>
