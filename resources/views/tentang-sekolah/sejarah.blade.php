...
@section('content')
    <section class="page__title-area page__title-height page__title-overlay d-flex align-items-center" data-background="{{ asset('upload/' . $history->background) }}">
        <div class="container">
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper mt-100">
                        <h3 class="page__title text-uppercase">Sejarah Sekolah</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#" disabled="disabled">Tentang Sekolah</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Sejarah Sekolah</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="content__info">
                                <div class="content__info-content">
                                    <ul>
                                        ...
                                        <li class="d-flex align-items-center">
                                            <div class="content__info-item">
                                                <h5><span><a href="{{ route('sejarah') }}" class="selected">Sejarah Sekolah</a></span></h5>
                                            </div>
                                        </li>
                                        <li class="d-flex align-items-center">
                                            <div class="content__info-item">
